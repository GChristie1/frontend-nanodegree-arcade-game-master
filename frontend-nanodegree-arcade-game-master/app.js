...
* @param {integer} - the speed of the Enemy Bugs
...
var Player = function() {
    ...
    // this gives the starting position of the player
    this.x = 200;
    this.y = 370;
...
Player.prototype.update = function(dt) {
    ...
    // this is called to update any time the player has collision
     // with the enemy 
    this.hitDetection();
...
/**
* @description Gives the user ability to go different directions
* @param {keystrokes} userinput
